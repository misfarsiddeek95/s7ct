...
import { FaHotel, FaUtensils, FaClock,FaCarSide} from "react-icons/fa"


import { tourDetailAbout, packages } from "@/app/data/data";
                ...
                <div className="container relative">
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                        <div className="lg:col-span-8 md:col-span-7">
                            ...
                            <h4 className="text-2xl font-semibold mt-5">Sri Lanka Tour Package 3 Days</h4>
                            ...
                            <div className="mt-6">
                                ...
                                <ul className="list-disc list-inside">
                                    ...
                                    <li className="text-slate-400 mt-3">Warm welcome from our S7TRAVELS representative and driver at the airport</li>
                                    <li className="text-slate-400 mt-3">Proceed to beautiful Kandy city</li>
                                    <li className="text-slate-400 mt-3">On the way, stop by at Pinnawala Elephant Orphanage</li>
                                    <li className="text-slate-400 mt-3">Check in at the tropical hotel</li>
                                    <li className="text-slate-400 mt-3">Later visit Kandy Temple of the Tooth relic</li>
                                    <li className="text-slate-400 mt-3">Visit the Spice village</li>
                                    <li className="text-slate-400 mt-3">Learn how the best spices in the world are made</li>
                                    <li className="text-slate-400 mt-3">Go for a village walk with the friendly locals</li>
                                    <li className="text-slate-400 mt-3">Enjoy a traditional Sri Lankan dinner buffet</li>
                                    <li className="text-slate-400 mt-3">Overnight stay at the hotel in Kandy</li>
                                </ul>
