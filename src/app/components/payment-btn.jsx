...
export default function PaymentBtn(){
    ...
    return(
        ...
        <li className="py-6 border-t border-gray-100 dark:border-gray-700">
            <Link href="#" scroll={false} onClick={()=>setOpenModal(!openModal)} className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md">Add Payment Method</Link>
        </li>
        {openModal && (
