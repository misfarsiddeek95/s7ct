    ...
    return(
        ...
        <div className="container relative md:mt-24 mt-16">
            <div className="grid grid-cols-1 text-center">
                ...
                <div className="mt-6">
                    <Link href="/helpcenter-support" className="py-2 px-5 inline-flex items-center font-semibold tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md me-2 mt-2"><FiPhone className="size-4 me-1"></FiPhone> Contact us</Link>
                </div>
            </div>
        </div>
        </>
