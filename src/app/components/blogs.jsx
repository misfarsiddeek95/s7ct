                        ...
                        return(
                            <div className="group relative overflow-hidden" key={index}>
                                ...
                                <div className="mt-6">
                                    ...
                                    <Link href={`/blog-detail/${item.id}`} className="text-lg font-medium hover:text-red-500 duration-500 ease-in-out">{item.title}</Link>
                                    <p className="text-slate-400 mt-2">{item.desc}</p>

                                    <div className="mt-3">
                                        <Link href={`/blog-detail/${item.id}`} className="hover:text-red-500 inline-flex items-center">Read More <FiChevronRight className="size-4 ms-1"></FiChevronRight></Link>
                                    </div>
                                </div>
                            </div>
                        )
