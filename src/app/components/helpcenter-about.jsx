                    ...
                    return(
                        <div className="text-center px-6 mt-6" key={index}>
                            ...
                            <div className="content mt-7">
                                <Link href={item.link} className="h5 text-lg font-medium hover:text-red-500">{item.title}</Link>
                                <p className="text-slate-400 mt-3">{item.desc}</p>
                                
                                <div className="mt-5">
                                    <Link href={item.link} className="text-red-500">Read More <i className="mdi mdi-chevron-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    )
