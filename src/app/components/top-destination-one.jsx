                            ...
                            return(
                                <div className="tiny-slide" key={index}>
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800 m-2">
                                        <Image src={item.image} width={0} height={0} sizes="100vw" style={{width:'0', height:'auto'}} className="w-full h-72 object-cover scale-125 group-hover:scale-100 duration-500" alt=""/>
                                        ...
                                        <div className="absolute p-4 bottom-0 start-0">
                                            <Link href="" className="text-lg font-medium text-white hover:text-red-500 duration-500 ease-in-out">{item.place}</Link>
