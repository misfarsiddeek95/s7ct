        ...
        <div className="lg:col-span-4 md:col-span-6">
            <div className="sticky top-20">
                ...
                <div className="text-center mt-8">
                    ...
                    <Link href="" className="text-lg font-medium hover:text-red-500 transition-all duration-500 ease-in-out h5">Cristina Romsey</Link>
                ...
                <ul className="list-none text-center mt-8 space-x-0.5">
                    {blogSocial.map((item,index)=>{
                        let Icon = item
                        return(
                            <li className="inline" key={index}><Link href="" className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-red-500 hover:text-white hover:bg-red-500"><Icon className="size-4"></Icon></Link></li>
                        )
                    })}
                </ul>
            </div>
